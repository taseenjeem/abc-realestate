...
import property1 from "../../assets/images/04.webp";
import { MdCategory } from "react-icons/md";
import { RiPieChart2Fill, RiCheckboxCircleFill } from "react-icons/ri";
import "react-image-gallery/styles/scss/image-gallery.scss";
import ImageGallery from "react-image-gallery";
import img1 from "../../assets/images/Property4/03.webp";
import img2 from "../../assets/images/Property4/05.webp";
import img3 from "../../assets/images/Property4/09.webp";
import img4 from "../../assets/images/Property4/13.webp";
import img5 from "../../assets/images/Property4/16.webp";
import img6 from "../../assets/images/Property4/17.webp";
      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-0 mb-40 mt-28">
        ...
        <div className="grid lg:grid-cols-3 lg:gap-10 gap-7">
          <div className="bg-primary border rounded shadow-lg mx-auto w-full p-4">
            <p className="text-lg text-white w-full">
              <RiCheckboxCircleFill className="inline text-white text-2xl relative bottom-[2px] mr-2" />{" "}
              Downpayment: AED 50,000
            </p>
          </div>
          <div className="bg-primary border rounded shadow-lg mx-auto w-full p-4">
            <p className="text-lg text-white w-full">
              <RiCheckboxCircleFill className="inline text-white text-2xl relative bottom-[2px] mr-2" />{" "}
              60 days from DP: AED 50,000
            </p>
          </div>
          <div className="bg-primary border rounded shadow-lg mx-auto w-full p-4">
            <p className="text-lg text-white w-full">
              <RiCheckboxCircleFill className="inline text-white text-2xl relative bottom-[2px] mr-2" />{" "}
              90 days from DP: AED 50,000
            </p>
          </div>
          <div className="bg-primary border rounded shadow-lg mx-auto w-full p-4">
            <p className="text-lg text-white w-full">
              <RiCheckboxCircleFill className="inline text-white text-2xl relative bottom-[2px] mr-2" />{" "}
              120 days from DP: AED 50,000
            </p>
          </div>
          <div className="bg-primary border rounded shadow-lg mx-auto w-full p-4">
            <p className="text-lg text-white w-full">
              <RiCheckboxCircleFill className="inline text-white text-2xl relative bottom-[2px] mr-2" />{" "}
              150 days from DP: AED 50,000
            </p>
          </div>
          <div className="bg-primary border rounded shadow-lg mx-auto w-full p-4">
            <p className="text-lg text-white w-full">
